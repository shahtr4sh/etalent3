                                ...
                                Grid::make(1)
                                    ...
                                    ->schema([
                                        ImageEntry::make('gambar_profil')
                                            ...
                                            ->width(100)
                                            ->circular()
                                            ->getStateUsing(fn () => $pemohon->gambar_profil)
                                            ->defaultImageUrl(url('https://ui-avatars.com/api/?name=' . urlencode($pemohon->nama) . '&size=100&background=8B5CF6&color=fff')),
                                    ])
                                    ->extraAttributes([
                                        'class' => 'flex items-start justify-center',
                                    ]),

                                // Column 2: Info (10 kolum)
                                Grid::make(1)
                                    ->columnSpan(10)
                                    ->schema([
                                        // Baris 1: ID Staf
                                        ...
                                        // Baris 3: Maklumat kontak (2 column grid)
                                        Grid::make(2)
                                            ->schema([
